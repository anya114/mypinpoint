...
public class DefaultProfilerConfig implements ProfilerConfig {
  ...
  private static class BypassResolver implements ValueResolver {
    ...
    @Override public String resolve(String value, Properties properties) {
      return value;
    }
  }
    ...
    try {
      ...
      if (logger.isLoggable(Level.WARNING)) {
        logger.log(Level.WARNING,
            pinpointConfigFileName + " file does not exist. Please check your configuration.");
      }
      throw fe;
    } catch (IOException e) {
      if (logger.isLoggable(Level.WARNING)) {
        logger
            .log(Level.WARNING, pinpointConfigFileName + " file I/O error. Error:" + e.getMessage(),
                e);
      }
      throw e;
    }
  ...
  @Override public String getCollectorSpanServerIp() {
    return collectorSpanServerIp;
  }

  @Override public int getCollectorSpanServerPort() {
    return collectorSpanServerPort;
  }

  @Override public String getCollectorStatServerIp() {
    return collectorStatServerIp;
  }

  @Override public int getCollectorStatServerPort() {
    return collectorStatServerPort;
  }

  @Override public String getCollectorTcpServerIp() {
    return collectorTcpServerIp;
  }

  @Override public int getCollectorTcpServerPort() {
    return collectorTcpServerPort;
  }

  @Override public int getStatDataSenderWriteQueueSize() {
    return statDataSenderWriteQueueSize;
  }

  @Override public int getStatDataSenderSocketSendBufferSize() {
    return statDataSenderSocketSendBufferSize;
  }

  @Override public int getStatDataSenderSocketTimeout() {
    return statDataSenderSocketTimeout;
  }

  @Override public int getSpanDataSenderWriteQueueSize() {
    return spanDataSenderWriteQueueSize;
  }

  @Override public int getSpanDataSenderSocketSendBufferSize() {
    return spanDataSenderSocketSendBufferSize;
  }

  @Override public boolean isTcpDataSenderCommandAcceptEnable() {
    return tcpDataSenderCommandAcceptEnable;
  }

  @Override public boolean isTraceAgentActiveThread() {
    return traceAgentActiveThread;
  }

  @Override public int getSpanDataSenderSocketTimeout() {
    return spanDataSenderSocketTimeout;
  }

  @Override public int getSpanDataSenderChunkSize() {
    return spanDataSenderChunkSize;
  }

  @Override public int getStatDataSenderChunkSize() {
    return statDataSenderChunkSize;
  }

  @Override public boolean isProfileEnable() {
    return profileEnable;
  }

  @Override public int getJdbcSqlCacheSize() {
    return jdbcSqlCacheSize;
  }

  @Override public boolean isTraceSqlBindValue() {
    return traceSqlBindValue;
  }

  @Override public int getMaxSqlBindValueSize() {
    return maxSqlBindValueSize;
  }

  @Override public boolean isSamplingEnable() {
  ...
  @Override public boolean isIoBufferingEnable() {
    return ioBufferingEnable;
  }

  @Override public int getIoBufferingBufferSize() {
    return ioBufferingBufferSize;
  }

  @Override public int getProfileJvmCollectInterval() {
    return profileJvmCollectInterval;
  }

  @Override public long getAgentInfoSendRetryInterval() {
    return agentInfoSendRetryInterval;
  }

  @Override public boolean isTomcatHidePinpointHeader() {
    return tomcatHidePinpointHeader;
  }

  @Override public boolean isTomcatTraceRequestParam() {
    return tomcatTraceRequestParam;
  }

  @Override public Filter<String> getTomcatExcludeUrlFilter() {
    return tomcatExcludeUrlFilter;
  }

  @Override public String getTomcatRealIpHeader() {
    return tomcatRealIpHeader;
  }

  @Override public String getTomcatRealIpEmptyValue() {
    return tomcatRealIpEmptyValue;
  }

  @Override public Filter<String> getTomcatExcludeProfileMethodFilter() {
  ...
  @Override public boolean isApacheHttpClient3Profile() {
    return apacheHttpClient3Profile;
  }

  @Override public boolean isApacheHttpClient3ProfileCookie() {
    return apacheHttpClient3ProfileCookie;
  }

  @Override public DumpType getApacheHttpClient3ProfileCookieDumpType() {
    return apacheHttpClient3ProfileCookieDumpType;
  }

  @Override public int getApacheHttpClient3ProfileCookieSamplingRate() {
    return apacheHttpClient3ProfileCookieSamplingRate;
  }

  @Override public boolean isApacheHttpClient3ProfileEntity() {
    return apacheHttpClient3ProfileEntity;
  }

  @Override public DumpType getApacheHttpClient3ProfileEntityDumpType() {
    return apacheHttpClient3ProfileEntityDumpType;
  }

  @Override public int getApacheHttpClient3ProfileEntitySamplingRate() {
    return apacheHttpClient3ProfileEntitySamplingRate;
  }

  @Override public boolean isApacheHttpClient3ProfileIo() {
    return apacheHttpClient3ProfileIo;
  }

  //-----------------------------------------
  // http apache client 4
  @Override public boolean isApacheHttpClient4Profile() {
    return apacheHttpClient4Profile;
  }

  @Override public boolean isApacheHttpClient4ProfileCookie() {
    return apacheHttpClient4ProfileCookie;
  }

  @Override public DumpType getApacheHttpClient4ProfileCookieDumpType() {
    return apacheHttpClient4ProfileCookieDumpType;
  }

  @Override public int getApacheHttpClient4ProfileCookieSamplingRate() {
    return apacheHttpClient4ProfileCookieSamplingRate;
  }

  @Override public boolean isApacheHttpClient4ProfileEntity() {
    return apacheHttpClient4ProfileEntity;
  }

  @Override public DumpType getApacheHttpClient4ProfileEntityDumpType() {
    return apacheHttpClient4ProfileEntityDumpType;
  }

  @Override public int getApacheHttpClient4ProfileEntitySamplingRate() {
    return apacheHttpClient4ProfileEntitySamplingRate;
  }

  @Override public boolean isApacheHttpClient4ProfileStatusCode() {
    return apacheHttpClient4ProfileStatusCode;
  }

  @Override public boolean isApacheHttpClient4ProfileIo() {
    return apacheHttpClient4ProfileIo;
  }

  //-----------------------------------------
  // org/apache/http/impl/nio/*
  @Override public boolean getApacheNIOHttpClient4Profile() {
    return apacheNIOHttpClient4Profile;
  }

  @Override public boolean isIBatisEnabled() {
    return ibatis;
  }

  @Override public boolean isMyBatisEnabled() {
    return mybatis;
  }

  @Override public boolean isRedisEnabled() {
    return redis;
  }

  @Override public boolean isRedisPipelineEnabled() {
    return redisPipeline;
  }

  @Override public Filter<String> getProfilableClassFilter() {
    return profilableClassFilter;
  }

  @Override public List<String> getApplicationTypeDetectOrder() {
    return applicationTypeDetectOrder;
  }

  @Override public List<String> getDisabledPlugins() {
    return disabledPlugins;
  }

  @Override public void setDisabledPlugins(List<String> disabledPlugins) {
    this.disabledPlugins = disabledPlugins;
  }

  @Override public String getApplicationServerType() {
    return applicationServerType;
  }

  @Override public void setApplicationServerType(String applicationServerType) {
    this.applicationServerType = applicationServerType;
  }

  @Override public boolean isLog4jLoggingTransactionInfo() {
    return this.log4jLoggingTransactionInfo;
  }


  @Override public boolean isLogbackLoggingTransactionInfo() {
    return this.logbackLoggingTransactionInfo;
  }

  @Override public int getCallStackMaxDepth() {
    return callStackMaxDepth;
  }

  @Override public void setCallStackMaxDepth(int callStackMaxDepth) {
    this.callStackMaxDepth = callStackMaxDepth;
  }

  @Override public boolean isPropagateInterceptorException() {
  ...
  void readPropertyValues() {
    ...
    this.collectorSpanServerIp =
        readString("profiler.collector.span.ip", DEFAULT_IP, placeHolderResolver);
    this.collectorSpanServerPort = readInt("profiler.collector.span.port", 9996);

    this.collectorStatServerIp =
        readString("profiler.collector.stat.ip", DEFAULT_IP, placeHolderResolver);
    this.collectorStatServerPort = readInt("profiler.collector.stat.port", 9995);

    this.collectorTcpServerIp =
        readString("profiler.collector.tcp.ip", DEFAULT_IP, placeHolderResolver);
    this.collectorTcpServerPort = readInt("profiler.collector.tcp.port", 9994);

    this.spanDataSenderWriteQueueSize =
        readInt("profiler.spandatasender.write.queue.size", 1024 * 5);
    this.spanDataSenderSocketSendBufferSize =
        readInt("profiler.spandatasender.socket.sendbuffersize", 1024 * 64 * 16);
    ...
    this.statDataSenderWriteQueueSize =
        readInt("profiler.statdatasender.write.queue.size", 1024 * 5);
    this.statDataSenderSocketSendBufferSize =
        readInt("profiler.statdatasender.socket.sendbuffersize", 1024 * 64 * 16);
    ...
    this.tcpDataSenderCommandAcceptEnable =
        readBoolean("profiler.tcpdatasender.command.accept.enable", false);
    ...
    this.apacheHttpClient3ProfileCookieDumpType =
        readDumpType("profiler.apache.httpclient3.cookie.dumptype", DumpType.EXCEPTION);
    this.apacheHttpClient3ProfileCookieSamplingRate =
        readInt("profiler.apache.httpclient3.cookie.sampling.rate", 1);

    this.apacheHttpClient3ProfileEntity = readBoolean("profiler.apache.httpclient3.entity", false);
    this.apacheHttpClient3ProfileEntityDumpType =
        readDumpType("profiler.apache.httpclient3.entity.dumptype", DumpType.EXCEPTION);
    this.apacheHttpClient3ProfileEntitySamplingRate =
        readInt("profiler.apache.httpclient3.entity.sampling.rate", 1);
    ...
    this.apacheHttpClient4ProfileCookieDumpType =
        readDumpType("profiler.apache.httpclient4.cookie.dumptype", DumpType.EXCEPTION);
    this.apacheHttpClient4ProfileCookieSamplingRate =
        readInt("profiler.apache.httpclient4.cookie.sampling.rate", 1);

    this.apacheHttpClient4ProfileEntity = readBoolean("profiler.apache.httpclient4.entity", false);
    this.apacheHttpClient4ProfileEntityDumpType =
        readDumpType("profiler.apache.httpclient4.entity.dumptype", DumpType.EXCEPTION);
    this.apacheHttpClient4ProfileEntitySamplingRate =
        readInt("profiler.apache.httpclient4.entity.sampling.rate", 1);

    this.apacheHttpClient4ProfileStatusCode =
        readBoolean("profiler.apache.httpclient4.entity.statuscode", true);
     ...
     * logback
     */
    this.logbackLoggingTransactionInfo =
        readBoolean("profiler.logback.logging.transactioninfo", false);
    ...
    this.agentInfoSendRetryInterval =
        readLong("profiler.agentInfo.send.retry.interval", DEFAULT_AGENT_INFO_SEND_RETRY_INTERVAL);
    ...
    this.propagateInterceptorException =
        readBoolean("profiler.interceptor.exception.propagate", false);

    logger.info("configuration loaded successfully.");
  }


  @Override public String readString(String propertyName, String defaultValue) {
  ...
  @Override public int readInt(String propertyName, int defaultValue) {
  ...
  @Override public DumpType readDumpType(String propertyName, DumpType defaultDump) {
  ...
  @Override public long readLong(String propertyName, long defaultValue) {
    String value = properties.getProperty(propertyName);
  ...
  @Override public List<String> readList(String propertyName) {
    String value = properties.getProperty(propertyName);
    if (value == null) {
  ...
  @Override public boolean readBoolean(String propertyName, boolean defaultValue) {
  ...
  @Override public List<String> getFaultInjectList() {
    return readList("pinpoint.faultinject");
  }

  @Override public boolean faultInjectEnable() {
    return readBoolean("pinpoint.faultinject.enable", false);
  }
