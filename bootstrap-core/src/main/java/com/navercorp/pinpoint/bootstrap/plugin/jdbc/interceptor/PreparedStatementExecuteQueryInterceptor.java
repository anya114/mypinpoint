 ...
 * @author emeroad
 */
@TargetMethods({@TargetMethod(name = "execute"), @TargetMethod(name = "executeQuery"),
...
public class PreparedStatementExecuteQueryInterceptor implements AroundInterceptor {
  ...
  public PreparedStatementExecuteQueryInterceptor(TraceContext traceContext,
      MethodDescriptor descriptor) {
    this(traceContext, descriptor, DEFAULT_BIND_VALUE_LENGTH);
  }

  public PreparedStatementExecuteQueryInterceptor(TraceContext traceContext,
      MethodDescriptor descriptor, int maxSqlBindValueLength) {
  ...
  public void after(Object target, Object[] args, Object result, Throwable throwable) {
    ...
    try {
      ...
      // TODO Test if it's success. if failed terminate. else calculate resultset fetch too. we'd
      // better make resultset fetch optional.
