...
public class JavaAssistTest {
  ...
  @Test public void newClass() {

  }

  @Test public void testAssist() throws NotFoundException, NoSuchMethodException {
  ...
  @Test public void genericTest() throws NotFoundException {
    ...
    CtMethod setStringArray = testClass
        .getDeclaredMethod("setStringArray", new CtClass[] {pool.get("java.lang.String[]")});
  ...
  @Test public void innerClass() throws NotFoundException {
    CtClass testClass = pool.get("com.navercorp.pinpoint.profiler.javaassist.TestClass");
    ...
    CtClass innerClass =
        pool.get("com.navercorp.pinpoint.profiler.javaassist.TestClass$InnerClass");
