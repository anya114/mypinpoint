...
public class JavassistClassTest {
  ...
  public void testClassHierarchy() throws InstrumentException {
    ...
    InstrumentClass classHierarchyObject = pool.getClass(null,
        "com.navercorp.pinpoint.profiler.interceptor.bci.ClassHierarchyTestMock", null);
  ...
  public void addTraceValue() throws Exception {
      ...
      public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader loader,
        ...
        try {
          ...
          aClass.getDeclaredMethod(methodName)
              .addInterceptor("com.navercorp.pinpoint.profiler.interceptor.TestBeforeInterceptor");
    ...
    Assert.assertTrue("DatabaseInfoTraceValue implements fail",
        databaseTraceValue.isInstance(testObject));
    databaseTraceValue.getMethod("_$PINPOINT$_setTraceDatabaseInfo", DatabaseInfo.class)
  ...
  public void testBeforeAddInterceptor() throws Exception {
    ...
    assertEqualsObjectField(interceptor, "className",
        "com.navercorp.pinpoint.profiler.interceptor.bci.TestObject");
  ...
  private Interceptor getInterceptor(final TestClassLoader loader, int index)
    ...
    Interceptor interceptor = (Interceptor) loader
        .loadClass("com.navercorp.pinpoint.profiler.interceptor.bci.TestInterceptors")
        .getMethod("get", int.class).invoke(null, index);
    return interceptor;
  }
  ...
  public void assertEqualsIntField(Object target, String fieldName, int value)
  ...
  public void assertEqualsObjectField(Object target, String fieldName, Object value)
      throws NoSuchFieldException, IllegalAccessException {
    Field field = target.getClass().getField(fieldName);
    ...
    loader.addTransformer(testClassObject, new TransformCallback() {
      ...
      public byte[] doInTransform(Instrumentor instrumentContext, ClassLoader classLoader,
        ...
        try {
          ...
          InstrumentClass aClass =
              instrumentContext.getInstrumentClass(classLoader, testClassObject, classfileBuffer);

          String methodName = "callA";
          aClass.getDeclaredMethod(methodName)
              .addInterceptor("com.navercorp.pinpoint.profiler.interceptor.TestAfterInterceptor");

          String methodName2 = "callB";
          aClass.getDeclaredMethod(methodName2)
              .addInterceptor("com.navercorp.pinpoint.profiler.interceptor.TestAfterInterceptor");
  ...
  public void hasEnclodingMethod() throws Exception {
    ...
    assertEquals(1, testObject.getNestedClasses(
        ClassFilters.enclosingMethod("enclosingMethod", "java.lang.String", "int")).size());
    assertEquals(0,
