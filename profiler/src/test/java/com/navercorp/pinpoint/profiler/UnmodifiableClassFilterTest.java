...
public class UnmodifiableClassFilterTest {
  ...
  public void testDoFilter_Package() throws Exception {
    ...
    Assert.assertSame(filter.accept(null, "com/navercorp/pinpoint/", null, null, null),
        ClassFileFilter.CONTINUE);
  ...
  public void testDoFilter_ClassLoader() throws Exception {
    ...
    Assert.assertSame(filter.accept(this.getClass().getClassLoader(), "test", null, null, null),
        ClassFileFilter.CONTINUE);

    URLClassLoader classLoader = new URLClassLoader(new URL[] {});
    Assert.assertSame(filter.accept(classLoader, "test", null, null, null),
        ClassFileFilter.CONTINUE);
  }
}
