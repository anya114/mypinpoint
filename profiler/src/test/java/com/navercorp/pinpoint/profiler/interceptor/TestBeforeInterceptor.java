...
public class TestBeforeInterceptor implements StaticAroundInterceptor {
  static {
    System.out
        .println("load TestBeforeInterceptor cl:" + TestBeforeInterceptor.class.getClassLoader());
  }
  ...
  public void before(Object target, String className, String methodName,
    ...
    logger.info("BEFORE target:" + target + " " + className + "." + methodName
        + parameterDescription + " args:" + Arrays.toString(args));
    this.target = target;
  ...
  @Override
  public void after(Object target, String className, String methodName, String parameterDescription,
