...
public class AnnotatedInterceptorFactoryTest {
  private final DefaultProfilerPluginContext pluginContext =
      mock(DefaultProfilerPluginContext.class);
  ...
  @Before public void setUp() {
    ...
    when(pluginContext.injectClass(any(ClassLoader.class), any(String.class)))
  ...
  @Test public void test0() throws Exception {
    ...
    Interceptor interceptor = factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor0.class.getName(), null, null,
            null, aClass, aMethod);
  ...
  @Test public void test1() throws Exception {
    ...
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor0.class.getName(), args, null,
            null, aClass, aMethod);
  ...
  @Test(expected = PinpointException.class) public void test2() throws Exception {
  ...
  @Test public void test3() throws Exception {
    ...
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor1.class.getName(), args, null,
            null, aClass, aMethod);
  ...
  @Test(expected = PinpointException.class) public void test7() throws Exception {
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor1.class.getName(), null, null,
            null, aClass, aMethod);
  }

  @Test(expected = PinpointException.class) public void test8() throws Exception {
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor1.class.getName(), null, null,
            null, aClass, aMethod);
  ...
  @Test public void test9() throws Exception {
    ...
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor2.class.getName(), args, null,
            null, aClass, aMethod);
  ...
  @Test public void test12() throws Exception {
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory
        .getInterceptor(getClass().getClassLoader(), TestInterceptor2.class.getName(), null, null,
            null, aClass, aMethod);
  ...
  @Test public void test15() throws Exception {
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(),
        AutomationInterceptor.class.getName(), null, null, null, aClass, aMethod);
    AutomationInterceptor automationInterceptor = (AutomationInterceptor) interceptor;
    assertNotNull(interceptor);
    assertNotNull(automationInterceptor.getDescriptor());
  }

  @Test public void test16() throws Exception {
    AnnotatedInterceptorFactory factory = new AnnotatedInterceptorFactory(pluginContext);
    Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(),
        PreparedStatementExecuteQueryInterceptor.class.getName(), null, null, null, aClass, aMethod);
    assertNotNull(interceptor);
  }
