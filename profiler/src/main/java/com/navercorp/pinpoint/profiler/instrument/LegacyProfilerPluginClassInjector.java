...
public class LegacyProfilerPluginClassInjector implements ClassInjector {
  private static final Logger logger =
      LoggerFactory.getLogger(LegacyProfilerPluginClassInjector.class);
  ...
  public <T> Class<? extends T> injectClass(ClassLoader classLoader, String className) {
    ...
    try {
      ...
      logger.warn("Failed to load plugin class {} with classLoader {}", className,
          targetClassLoader, e);
      throw new PinpointException(
          "Failed to load plugin class " + className + " with classLoader " + targetClassLoader, e);
    }
  }

  private Class<?> loadFromOtherClassLoader(ClassLoader classLoader, String className)
  ...
  private Class<?> loadFromOtherClassLoader(ClassPool pool, ClassLoader classLoader,
