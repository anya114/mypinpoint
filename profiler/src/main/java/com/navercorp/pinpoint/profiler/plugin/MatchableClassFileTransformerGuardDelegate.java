...
public class MatchableClassFileTransformerGuardDelegate implements MatchableClassFileTransformer {
  ...
  public MatchableClassFileTransformerGuardDelegate(InstrumentContext instrumentContext,
      Matcher matcher, TransformCallback transformCallback) {
  ...
  public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
    ...
    try {
      ...
      return transformCallback.doInTransform(guard, loader, className, classBeingRedefined,
