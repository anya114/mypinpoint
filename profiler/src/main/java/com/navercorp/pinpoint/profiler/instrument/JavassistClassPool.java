...
public class JavassistClassPool implements InstrumentClassPool {
  ...
  /**
   * add class repository to keep track the code instrumentation
   */
  private final ClassRepository classRepository = ClassRepository.INSTANCE;

  public JavassistClassPool(InterceptorRegistryBinder interceptorRegistryBinder,
      final String bootStrapJar) {
        ...
        new IsolateMultipleClassPool.ClassPoolHandler() {
          ...
          public void handleClassPool(NamedClassPool systemClassPool) {
            try {
              ...
              throw new PinpointException("bootStrapJar not found. Caused by:" + ex.getMessage(),
                  ex);
            }
  ...
  public InstrumentClass getClass(ClassLoader classLoader, String jvmInternalClassName,
      byte[] classFileBuffer) throws NotFoundInstrumentException {
    return getClass(null, classLoader, jvmInternalClassName, classFileBuffer);
  }
  ...
  private CtClass getClass(ClassLoader classLoader, String className)
