...
public class PostgreSqlPlugin implements ProfilerPlugin, TransformTemplateAware {
  ...
  private void addConnectionTransformer(final PostgreSqlConfig config) {
    transformTemplate.transform("org.postgresql.jdbc4.Jdbc4Connection", new TransformCallback() {
      ...
      public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
        ...
        target.addInterceptor(
            "com.navercorp.pinpoint.plugin.jdbc.postgresql.interceptor.PostgreSQLConnectionCreateInterceptor");
        target.addScopedInterceptor(
            "com.navercorp.pinpoint.plugin.jdbc.postgresql.interceptor.PostgreSqlPreparedStatementCreateInterceptor3",
            PostgreSqlConstants.POSTGRESQL_SCOPE);
    ...
    transformTemplate.transform("org.postgresql.jdbc2.AbstractJdbc2Connection",
        new TransformCallback() {
          ...
          public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader,
            ...
            target.addScopedInterceptor(
                ...
                PostgreSqlConstants.POSTGRESQL_SCOPE);
            target.addScopedInterceptor(
                "com.navercorp.pinpoint.plugin.jdbc.postgresql.interceptor.PostgreSqlPreparedStatementCreateInterceptor1",
                PostgreSqlConstants.POSTGRESQL_SCOPE);
    ...
    transformTemplate.transform("org.postgresql.jdbc3.AbstractJdbc3Connection",
        new TransformCallback() {
          ...
          public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader,
            ...
            target.addScopedInterceptor(
                "com.navercorp.pinpoint.plugin.jdbc.postgresql.interceptor.PostgreSqlPreparedStatementCreateInterceptor2",
                PostgreSqlConstants.POSTGRESQL_SCOPE);
    ...
    transformTemplate.transform("org.postgresql.Driver", new TransformCallback() {
      ...
      public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader, String className,
        ...
        target.addScopedInterceptor(
            ...
            va(new PostgreSqlJdbcUrlParser(), false), PostgreSqlConstants.POSTGRESQL_SCOPE,
  ...
  private void addPreparedStatementTransformer(final PostgreSqlConfig config) {
    transformTemplate.transform("org.postgresql.jdbc2.AbstractJdbc2Statement",
        new TransformCallback() {
          ...
          public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader,
            ...
            target.addScopedInterceptor(
                ...
                va(maxBindValueSize), PostgreSqlConstants.POSTGRESQL_SCOPE);

            return target.toBytecode();
          }
        });
    transformTemplate.transform("org.postgresql.jdbc3.AbstractJdbc3Statement",
        new TransformCallback() {
          ...
          public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader,
            ...
            final PreparedStatementBindingMethodFilter excludes =
            ...
            target.addScopedInterceptor(excludes,
                ...
                PostgreSqlConstants.POSTGRESQL_SCOPE, ExecutionPolicy.BOUNDARY);
