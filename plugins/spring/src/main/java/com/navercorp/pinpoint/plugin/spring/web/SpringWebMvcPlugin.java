...
public class SpringWebMvcPlugin implements ProfilerPlugin, TransformTemplateAware {
  ...
  public void setup(ProfilerPluginSetupContext context) {
    transformTemplate.transform("org.springframework.web.servlet.FrameworkServlet",
        new TransformCallback() {
          ...
          public byte[] doInTransform(Instrumentor instrumentor, ClassLoader loader,
            ...
            target
                .getDeclaredMethod("doGet", "javax.servlet.http.HttpServletRequest",
                    "javax.servlet.http.HttpServletResponse")
                .addInterceptor(BasicMethodInterceptor.class.getName(), va(SPRING_MVC));
            target
                .getDeclaredMethod("doPost", "javax.servlet.http.HttpServletRequest",
                    "javax.servlet.http.HttpServletResponse")
                .addInterceptor(BasicMethodInterceptor.class.getName(), va(SPRING_MVC));
